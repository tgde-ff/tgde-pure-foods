        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
              Pure From Nature.
              <span className="block text-primary mt-2">Pure For You.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <div className="flex items-center gap-2 text-foreground/80">
                ...
                <span className="text-sm font-medium">Family Safe</span>
              </div>
              <div className="flex items-center gap-2 text-foreground/80">
                <Leaf className="w-5 h-5 text-secondary" />
                <span className="text-sm font-medium">No Additives</span>
              </div>
            </div>
          </div>
